...
class MessagesTest extends AbstractTest
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertAttributeSame(Krexx::$pool, 'pool', $this->messagesClass);
    }
    ...
    public function testAddMessage()
    {
        ...
        $this->assertAttributeSame(
            ...
            static::KEY_VARIABLE_NAME,
            $this->messagesClass
        );
        $this->assertAttributeSame([''], 'messages', $this->messagesClass);
    }
    ...
    public function testRemoveKex()
    {
        ...
        $this->assertAttributeEquals([], static::KEY_VARIABLE_NAME, $this->messagesClass);
    }
    ...
    public function testReadHelpTexts()
    {
        ...
        $this->assertAttributeEquals(['someKey' => 'a string'], 'helpArray', $this->messagesClass);
    }
}