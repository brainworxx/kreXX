...
class Krexx
{
    ...
    public static function bootstrapKrexx()
    {
        ...
        include_once $krexxdir . 'src/model/output/Footer.php';
        include_once $krexxdir . 'src/model/output/FooterSection.php';
        include_once $krexxdir . 'src/model/output/Backtrace.php';
        include_once $krexxdir . 'src/model/variables/AnalyseArray.php';
        include_once $krexxdir . 'src/model/variables/IterateThrough.php';
        include_once $krexxdir . 'src/model/objects/AnalyseObject.php';
        include_once $krexxdir . 'src/model/objects/Properties.php';
        include_once $krexxdir . 'src/model/objects/Constants.php';
        include_once $krexxdir . 'src/model/objects/IterateThroughConstants.php';
        include_once $krexxdir . 'src/model/objects/AnalyseMethods.php';
        include_once $krexxdir . 'src/model/objects/MethodInfo.php';
        include_once $krexxdir . 'src/model/objects/IterateThroughTraversable.php';
        include_once $krexxdir . 'src/model/objects/Closure.php';
