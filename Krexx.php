...
class Krexx
{
    ...
    public static function bootstrapKrexx()
    {
        ...
        include_once $krexxdir . 'src/model/callback/IterateThroughConfig.php';
        include_once $krexxdir . 'src/model/callback/AnalysisBacktrace.php';
        include_once $krexxdir . 'src/model/callback/AnalyseArray.php';
        include_once $krexxdir . 'src/model/callback/AnalyseObject.php';
        include_once $krexxdir . 'src/model/callback/IterateThroughProperties.php';
