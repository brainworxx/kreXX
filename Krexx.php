...
class Krexx
{
    ...
    public static function bootstrapKrexx()
    {
        ...
        include $krexxDir . 'src/service/view/Help.php';
        include $krexxDir . 'src/service/view/Render.php';
        include $krexxDir . 'src/service/view/Messages.php';
        include $krexxDir . 'src/service/config/Model.php';
        include $krexxDir . 'src/service/config/Fallback.php';
        include $krexxDir . 'src/service/config/Security.php';
        ...
        include $krexxDir . 'src/service/flow/Emergency.php';
        include $krexxDir . 'src/analysis/Flection.php';
        include $krexxDir . 'src/analysis/routing/AbstractRouting.php';
        include $krexxDir . 'src/analysis/routing/Routing.php';
        include $krexxDir . 'src/analysis/process/AbstractProcess.php';
        include $krexxDir . 'src/analysis/process/ProcessArray.php';
        include $krexxDir . 'src/analysis/process/ProcessBacktrace.php';
        include $krexxDir . 'src/analysis/process/ProcessBoolean.php';
        include $krexxDir . 'src/analysis/process/ProcessClosure.php';
        include $krexxDir . 'src/analysis/process/ProcessFloat.php';
        include $krexxDir . 'src/analysis/process/ProcessInteger.php';
        include $krexxDir . 'src/analysis/process/ProcessNull.php';
        include $krexxDir . 'src/analysis/process/ProcessObject.php';
        include $krexxDir . 'src/analysis/process/ProcessResource.php';
        include $krexxDir . 'src/analysis/process/ProcessString.php';
        include $krexxDir . 'src/analysis/Model.php';
        include $krexxDir . 'src/analysis/Scope.php';
        include $krexxDir . 'src/analysis/callback/AbstractCallback.php';
        include $krexxDir . 'src/analysis/callback/analyse/BacktraceStep.php';
        include $krexxDir . 'src/analysis/callback/analyse/ConfigSection.php';
        include $krexxDir . 'src/analysis/callback/analyse/Debug.php';
        include $krexxDir . 'src/analysis/callback/analyse/Objects.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughArray.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughConfig.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughConstants.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughMethodAnalysis.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughMethods.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughProperties.php';
        include $krexxDir . 'src/analysis/callback/iterate/ThroughGetter.php';
        include $krexxDir . 'src/analysis/caller/AbstractCaller.php';
        include $krexxDir . 'src/analysis/caller/Php.php';
        include $krexxDir . 'src/analysis/comment/AbstractComment.php';
        include $krexxDir . 'src/analysis/comment/Methods.php';
        include $krexxDir . 'src/analysis/comment/Functions.php';
        include $krexxDir . 'src/errorhandler/Error.php';
        include $krexxDir . 'src/errorhandler/Fatal.php';
        include $krexxDir . 'src/controller/Internals.php';
        include $krexxDir . 'src/controller/OutputActions.php';
